...
class NostrRelayManager private constructor() {
    ...
    companion object {
        ...
        private const val INITIAL_BACKOFF_INTERVAL = 1_000L  // 1 second
        private const val MAX_BACKOFF_INTERVAL = 300_000L    // 5 minutes
        private const val BACKOFF_MULTIPLIER = 2.0
        private const val MAX_RECONNECT_ATTEMPTS = 10
        private const val SUBSCRIPTION_VALIDATION_INTERVAL = 30_000L // 30 seconds
    ...
    // OkHttp client for WebSocket connections (via provider)
    private val httpClient: OkHttpClient
        get() = me.bitpoints.wallet.net.OkHttpProvider.webSocketClient()
    ...
    fun unsubscribe(id: String) {
        ...
        scope.launch {
            connections.entries.forEach { (relayUrl, webSocket) ->
