...
export const useRecoverbullKeyServerStore = defineStore(
  "recoverbullKeyServer",
  {
    ...
    getters: {
      ...
      isCoolingDown: (state) => {
        ...
        const expiresAt =
          requested + state.rateLimit.cooldownMinutes * 60 * 1000;
      ...
      cooldownRemainingMs(): number | null {
        ...
        const expiresAt =
          requested + this.rateLimit.cooldownMinutes * 60 * 1000;
    ...
    actions: {
      setBaseUrl(url: string) {
        ...
        this.baseUrl =
          sanitized.length > 0 ? sanitized : DEFAULT_KEY_SERVER_URL;
      },
